    ...
    <xsl:template match="pmd">
        <html>
            <head>
                ...
                <style type="text/css">                    body {                    margin-left: 10;                    margin-right: 10;                    font:normal 80% arial,helvetica,sanserif;                    background-color:#FFFFFF;                    color:#000000;                    }                    .a td { background: #efefef; }                    .b td { background: #fff; }                    th, td { text-align: left; vertical-align: top; }                    th { font-weight:bold; background: #ccc; color: black; }                    table, th, td { font-size:100%; border: none }                    table.log tr td, tr th { }                    h2 {                    font-weight:bold;                    font-size:120%;                    margin-top: 2;                    margin-bottom: 2;                    }                    h3 {                    font-size:100%;                    font-weight:bold;                    background: #525D76;                    color: white;                    text-decoration: none;                    padding: 5px;                    margin-right: 2px;                    margin-left: 2px;                    margin-bottom: 0;                    }                    .p1 { text-align:center; color:#000000; background:#FF4444; }                    .p2 { text-align:center; color:#000000; background:#FF9999; }                    .p3 { text-align:center; color:#000000; background:#FFFF99; }                    .p4 { text-align:center; color:#000000; background:#DCFF20; }                    .p5 { text-align:center; color:#000000; background:#33CC33; }                </style>
            </head>
            <body>
                <a name="top"/>
                <hr/>
    ...
    <xsl:template match="pmd" mode="filelist">
        ...
        <table class="log" border="0" cellpadding="5" cellspacing="2" width="100%">
            ...
            <xsl:for-each select="file">
                ...
                <xsl:sort data-type="string" order="descending" select="count(violation[@priority = 1]) * 10000000000000000 + count(violation[@priority = 2]) * 1000000000000 + count(violation[@priority = 3]) * 100000000 + count(violation[@priority = 4]) * 10000 + count(violation[@priority = 5])"/>
                <!-- <xsl:sort select="@name"/> -->
                    ...
                    <td>
                        <div>
                            ...
                            <xsl:choose>
                                ...
                                <xsl:otherwise>
                                    <xsl:value-of select="$highestPriorityCount"/>
                                    of
                                    <xsl:value-of select="$violationCount"/>
                                </xsl:otherwise>
                            </xsl:choose>
